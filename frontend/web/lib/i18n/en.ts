...
const en = {
  ...
  fetchConfirmEstimate: "Right now we estimate {price} per person for this day. That figure moves by season, not by date, so the real price can differ.",
  fetchConfirmCost: "Getting the actual flight and hotel prices for it uses 1 credit.",
