...
const en = {
  ...
  tripLengthNights: "Trip length (nights)",
  ...
  rangeHint:
    "Give a wider date range than your trip length and we'll search every valid start date in it (e.g. only Saturdays, if set above) for the best deal.",
  ...
  errorTripLength: "Trip length must be at least 1 night.",
