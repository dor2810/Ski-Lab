...
const he: Record<keyof typeof en, string> = {
  ...
  fetchConfirmEstimate: "כרגע ההערכה שלנו ליום הזה היא {price} לאדם. המספר הזה משתנה לפי עונה ולא לפי תאריך, ולכן המחיר האמיתי עשוי להיות שונה.",
  fetchConfirmCost: "שליפת מחירי הטיסה והמלון האמיתיים עבורו עולה קרדיט אחד.",
