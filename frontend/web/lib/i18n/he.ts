...
const he: Record<keyof typeof en, string> = {
  ...
  livePricingBlockedNote: "חלק מהמחירים למטה הם הערכות: שירות מחירי הטיסות חסם זמנית את הבדיקות האוטומטיות שלנו. הטיולים אמיתיים — המספרים האלה פשוט לא בזמן אמת כרגע. נסו שוב בעוד כמה דקות.",
