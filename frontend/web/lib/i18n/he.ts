...
const he: Record<keyof typeof en, string> = {
  ...
  priceCalendarStateLegend: "ימים מלאים הם טיולים שתמחרנו באמת וניתן לפתוח למטה. ימים מקווקווים הם הערכה שלנו — לחצו על אחד כדי לשלוף את המחיר האמיתי שלו (קרדיט אחד).",
